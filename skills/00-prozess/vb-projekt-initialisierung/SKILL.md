...
description: "VB-adaptierter Skill. Ursprung: skills/init/SKILL.md. Siehe VB-Kontext und Abgrenzung."
---
...
Prozess-Skill für den Start eines neuen Software- oder Produktvorhabens. Nützlich für frühe Projektideen, Produktvision, MVP-Abgrenzung und erste Feature-Landkarte.
...
VB-Hinweis: Dieser Skill ergänzt `vb-projektleitung` und `vb-analyse`, ersetzt aber keine Projektgenehmigung.
